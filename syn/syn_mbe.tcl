...
analyze -f vhdl -lib WORK ./src/FPmul_stage2_modified_MBE.vhd
...
analyze -f vhdl -lib WORK ./src/FPmul_with_reg_IN_MBE.vhd

set power_preserve_rtl_hier_names true
elaborate FPmul_with_reg_IN_MBE -arch pipeline -lib WORK > ./elaborate_mbe.txt
create_clock -name MY_CLK -period  4.2 clk
...
ungroup -all -flatten
compile
report_resources > recources_mbe.txt
